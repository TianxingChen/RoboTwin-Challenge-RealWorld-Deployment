...
class PiperConfig(PiperBase):
    ...
    def get_joint_limits(self, joint_name: Literal["j1", "j2", "j3", "j4", "j5", "j6"]):
        """Get joint limits
    ...
    def set_motor_speed_limit(
        self, motor_num: Literal[1, 2, 3, 4, 5, 6], max_speed: int
    ):
    ...
    def set_motor_acceleration_limit(
    ...
    def configure_joint(
        ...
        return self._interface.JointConfig(
            joint_num, set_zero, acc_param_effective, max_acc, clear_err
        )
