...
class C_PiperInterface_V2:
    ...
    class GripperTeachingPendantParamFeedback:
        ...
        def __init__(self):
            self.time_stamp: float = 0
            self.arm_gripper_teaching_param_feedback = (
    ...
    def __init__(
        ...
        self.__feedback_gripper_teaching_pendant_param = (
            self.GripperTeachingPendantParamFeedback()
        )
    ...
    def ConnectPort(
        self, can_init: bool = False, piper_init: bool = True, start_thread: bool = True
    ):
        """
        ...
        try:
            if start_thread:
                ...
                if not self.__can_monitor_th or not self.__can_monitor_th.is_alive():
                    self.__can_monitor_th = threading.Thread(
                        target=CanMonitor, daemon=True
                    )
    ...
    def GetArmEndPoseMsgs(self):
        ...
        with self.__arm_end_pose_mtx:
            self.__arm_end_pose.Hz = self.__fps_counter.cal_average(
                self.__fps_counter.get_real_time_fps("ArmEndPose_XY"),
    ...
    def GetArmJointMsgs(self):
        ...
        with self.__arm_joint_msgs_mtx:
            self.__arm_joint_msgs.Hz = self.__fps_counter.cal_average(
                self.__fps_counter.get_real_time_fps("ArmJoint_12"),
    ...
    def GetArmGripperMsgs(self):
        ...
        with self.__arm_gripper_msgs_mtx:
            self.__arm_gripper_msgs.Hz = self.__fps_counter.get_real_time_fps(
                "ArmGripper"
            )
    ...
    def GetArmHighSpdInfoMsgs(self):
        ...
        with self.__arm_motor_info_high_spd_mtx:
            self.__arm_motor_info_high_spd.Hz = self.__fps_counter.cal_average(
                self.__fps_counter.get_real_time_fps("ArmMotorDriverInfoHighSpd_1"),
    ...
    def GetArmLowSpdInfoMsgs(self):
        ...
        with self.__arm_motor_info_low_spd_mtx:
            self.__arm_motor_info_low_spd.Hz = self.__fps_counter.cal_average(
                self.__fps_counter.get_real_time_fps("ArmMotorDriverInfoLowSpd_1"),
    ...
    def GetArmEnableStatus(self) -> list:
        ...
        enable_list = []
        enable_list.append(
            self.GetArmLowSpdInfoMsgs().motor_1.foc_status.driver_enable_status
        )
        enable_list.append(
            self.GetArmLowSpdInfoMsgs().motor_2.foc_status.driver_enable_status
        )
        enable_list.append(
            self.GetArmLowSpdInfoMsgs().motor_3.foc_status.driver_enable_status
        )
        enable_list.append(
            self.GetArmLowSpdInfoMsgs().motor_4.foc_status.driver_enable_status
        )
        enable_list.append(
            self.GetArmLowSpdInfoMsgs().motor_5.foc_status.driver_enable_status
        )
        enable_list.append(
            self.GetArmLowSpdInfoMsgs().motor_6.foc_status.driver_enable_status
        )
        return enable_list
    ...
    def GetArmJointCtrl(self):
        ...
        with self.__arm_joint_ctrl_msgs_mtx:
            self.__arm_joint_ctrl_msgs.Hz = self.__fps_counter.cal_average(
                self.__fps_counter.get_real_time_fps("ArmJointCtrl_12"),
    ...
    def GetArmGripperCtrl(self):
        ...
        with self.__arm_gripper_ctrl_msgs_mtx:
            self.__arm_gripper_ctrl_msgs.Hz = self.__fps_counter.get_real_time_fps(
                "ArmGripperCtrl"
            )
    ...
    def GetArmCtrlCode151(self):
        ...
        with self.__arm_ctrl_code_151_mtx:
            self.__arm_ctrl_code_151.Hz = self.__fps_counter.get_real_time_fps(
                "ArmCtrlCode_151"
            )
    ...
    def GetArmModeCtrl(self):
        ...
        with self.__arm_mode_ctrl_mtx:
            self.__arm_mode_ctrl.Hz = self.__fps_counter.get_real_time_fps(
                "ArmModeCtrl"
            )
    ...
    def GetPiperFirmwareVersion(self):
        ...
        with self.__firmware_data_mtx:
            ...
            # 提取版本信息，截取固定长度的字节数据
            firmware_version = self.__firmware_data[version_start:version_end].decode(
                "utf-8", errors="ignore"
            )
    ...
    def __UpdateArmEndPoseState(self, msg: PiperMessage):
        ...
        with self.__arm_end_pose_mtx:
            ...
            self.__arm_end_pose.time_stamp = max(
    ...
    def __UpdateArmJointState(self, msg: PiperMessage):
        ...
        with self.__arm_joint_msgs_mtx:
            if msg.type_ == ArmMsgType.PiperMsgJointFeedBack_12:
                ...
                self.__arm_joint_msgs.joint_state.joint_1 = self.__CalJointSDKLimit(
                    msg.arm_joint_feedback.joint_1, "j1"
                )
                self.__arm_joint_msgs.joint_state.joint_2 = self.__CalJointSDKLimit(
                    msg.arm_joint_feedback.joint_2, "j2"
                )
                ...
                self.__arm_joint_msgs.joint_state.joint_3 = self.__CalJointSDKLimit(
                    msg.arm_joint_feedback.joint_3, "j3"
                )
                self.__arm_joint_msgs.joint_state.joint_4 = self.__CalJointSDKLimit(
                    msg.arm_joint_feedback.joint_4, "j4"
                )
                ...
                self.__arm_joint_msgs.joint_state.joint_5 = self.__CalJointSDKLimit(
                    msg.arm_joint_feedback.joint_5, "j5"
                )
                self.__arm_joint_msgs.joint_state.joint_6 = self.__CalJointSDKLimit(
                    msg.arm_joint_feedback.joint_6, "j6"
                )
            else:
                pass
            # 更新时间戳，取筛选ID的最新一个
            self.__arm_joint_msgs.time_stamp = max(
        ...
        with self.__arm_gripper_msgs_mtx:
            if msg.type_ == ArmMsgType.PiperMsgGripperFeedBack:
                ...
                self.__arm_gripper_msgs.gripper_state.grippers_angle = (
                    self.__CalGripperSDKLimit(msg.gripper_feedback.grippers_angle)
                )
    ...
    def __UpdateDriverInfoHighSpdFeedback(self, msg: PiperMessage):
        ...
        with self.__arm_motor_info_high_spd_mtx:
            if msg.type_ == ArmMsgType.PiperMsgHighSpdFeed_1:
                ...
                self.__arm_time_stamp.time_stamp_motor_high_spd_1 = (
                    self.__GetCurrentTime()
                )
                ...
                self.__arm_motor_info_high_spd.motor_1.effort = (
                    msg.arm_high_spd_feedback_1.cal_effort()
                )
                ...
                self.__arm_motor_info_high_spd.motor_2.effort = (
                    msg.arm_high_spd_feedback_2.cal_effort()
                )
                ...
                self.__arm_motor_info_high_spd.motor_3.effort = (
                    msg.arm_high_spd_feedback_3.cal_effort()
                )
                ...
                self.__arm_motor_info_high_spd.motor_4.effort = (
                    msg.arm_high_spd_feedback_4.cal_effort()
                )
                ...
                self.__arm_motor_info_high_spd.motor_5.effort = (
                    msg.arm_high_spd_feedback_5.cal_effort()
                )
                ...
                self.__arm_motor_info_high_spd.motor_6.effort = (
                    msg.arm_high_spd_feedback_6.cal_effort()
                )
            else:
                pass
            # 更新时间戳，取筛选ID的最新一个
            self.__arm_motor_info_high_spd.time_stamp = max(
                self.__arm_time_stamp.time_stamp_motor_high_spd_1,
                self.__arm_time_stamp.time_stamp_motor_high_spd_2,
                self.__arm_time_stamp.time_stamp_motor_high_spd_3,
                self.__arm_time_stamp.time_stamp_motor_high_spd_4,
    ...
    def __UpdateDriverInfoLowSpdFeedback(self, msg: PiperMessage):
        ...
        with self.__arm_motor_info_low_spd_mtx:
            if msg.type_ == ArmMsgType.PiperMsgLowSpdFeed_1:
                ...
                pass
            # 更新时间戳，取筛选ID的最新一个
            self.__arm_motor_info_low_spd.time_stamp = max(
                self.__arm_time_stamp.time_stamp_motor_low_spd_1,
                self.__arm_time_stamp.time_stamp_motor_low_spd_2,
                self.__arm_time_stamp.time_stamp_motor_low_spd_3,
                self.__arm_time_stamp.time_stamp_motor_low_spd_4,
    ...
    def __UpdateAllCurrentMotorAngleLimitMaxVel(self, msg: PiperMessage):
        ...
        with self.__arm_all_motor_angle_limit_max_spd_mtx:
            if msg.type_ == ArmMsgType.PiperMsgFeedbackCurrentMotorAngleLimitMaxSpd:
                ...
                # 更新时间戳，取筛选ID的最新一个
                self.__arm_all_motor_angle_limit_max_spd.time_stamp = max(
                    self.__arm_time_stamp.time_stamp_motor_angle_limit_max_spd_1,
                    self.__arm_time_stamp.time_stamp_motor_angle_limit_max_spd_2,
                    self.__arm_time_stamp.time_stamp_motor_angle_limit_max_spd_3,
                    self.__arm_time_stamp.time_stamp_motor_angle_limit_max_spd_4,
    ...
    def __UpdateAllCurrentMotorMaxAccLimit(self, msg: PiperMessage):
        ...
        with self.__arm_all_motor_max_acc_limit_mtx:
            if msg.type_ == ArmMsgType.PiperMsgFeedbackCurrentMotorMaxAccLimit:
                ...
                # 更新时间戳，取筛选ID的最新一个
                self.__arm_all_motor_max_acc_limit.time_stamp = max(
                    self.__arm_time_stamp.time_stamp_motor_max_acc_limit_1,
                    self.__arm_time_stamp.time_stamp_motor_max_acc_limit_2,
                    self.__arm_time_stamp.time_stamp_motor_max_acc_limit_3,
                    self.__arm_time_stamp.time_stamp_motor_max_acc_limit_4,
    ...
    def __UpdateGripperTeachingPendantParamFeedback(self, msg: PiperMessage):
        ...
        with self.__feedback_gripper_teaching_pendant_param_mtx:
            if msg.type_ == ArmMsgType.PiperMsgGripperTeachingPendantParamFeedback:
                self.__feedback_gripper_teaching_pendant_param.time_stamp = (
                    self.__GetCurrentTime()
                )
    ...
    def __UpdateArmJointCtrl(self, msg: PiperMessage):
        ...
        with self.__arm_joint_ctrl_msgs_mtx:
            if msg.type_ == ArmMsgType.PiperMsgJointCtrl_12:
                ...
                self.__arm_joint_ctrl_msgs.joint_ctrl.joint_1 = self.__CalJointSDKLimit(
                    msg.arm_joint_ctrl.joint_1, "j1"
                )
                self.__arm_joint_ctrl_msgs.joint_ctrl.joint_2 = self.__CalJointSDKLimit(
                    msg.arm_joint_ctrl.joint_2, "j2"
                )
                ...
                self.__arm_joint_ctrl_msgs.joint_ctrl.joint_3 = self.__CalJointSDKLimit(
                    msg.arm_joint_ctrl.joint_3, "j3"
                )
                self.__arm_joint_ctrl_msgs.joint_ctrl.joint_4 = self.__CalJointSDKLimit(
                    msg.arm_joint_ctrl.joint_4, "j4"
                )
                ...
                self.__arm_joint_ctrl_msgs.joint_ctrl.joint_5 = self.__CalJointSDKLimit(
                    msg.arm_joint_ctrl.joint_5, "j5"
                )
                self.__arm_joint_ctrl_msgs.joint_ctrl.joint_6 = self.__CalJointSDKLimit(
                    msg.arm_joint_ctrl.joint_6, "j6"
                )
            else:
                pass
            # 更新时间戳，取筛选ID的最新一个
            self.__arm_joint_ctrl_msgs.time_stamp = max(
        ...
        with self.__arm_gripper_ctrl_msgs_mtx:
            if msg.type_ == ArmMsgType.PiperMsgGripperCtrl:
                ...
                self.__arm_gripper_ctrl_msgs.gripper_ctrl.grippers_angle = (
                    self.__CalGripperSDKLimit(msg.arm_gripper_ctrl.grippers_angle)
                )
    ...
    def __UpdateArmModeCtrl(self, msg: PiperMessage):
        ...
        with self.__arm_mode_ctrl_mtx:
            if msg.type_ == ArmMsgType.PiperMsgMotionCtrl_2:
                ...
                self.__arm_mode_ctrl.mode_ctrl.mit_mode = msg.arm_motion_ctrl_2.mit_mode
    ...
    def EmergencyStop(self, emergency_stop: Literal[0x00, 0x01, 0x02] = 0):
        """
        机械臂紧急停止以及重置
    ...
    def __ValidateEndPoseValue(self, endpose_num: str, endpose_value):
        ...
        if not isinstance(endpose_value, int):
            print(
                f"Error: EndPose_{endpose_num} value {endpose_value} is not an integer."
            )
            return False
        return True
    ...
    def EndPoseCtrl(self, X: int, Y: int, Z: int, RX: int, RY: int, RZ: int):
        ...
        """
        if (
            not self.__ValidateEndPoseValue("X", X)
            or not self.__ValidateEndPoseValue("Y", Y)
            or not self.__ValidateEndPoseValue("Z", Z)
            or not self.__ValidateEndPoseValue("RX", RX)
            or not self.__ValidateEndPoseValue("RY", RY)
            or not self.__ValidateEndPoseValue("RZ", RZ)
        ):
            return
    ...
    def MoveCAxisUpdateCtrl(
        self, instruction_num: Literal[0x00, 0x01, 0x02, 0x03] = 0x00
    ):
        """
        ...
        msg = PiperMessage(
            type_=ArmMsgType.PiperMsgCircularPatternCoordNumUpdateCtrl,
            arm_circular_ctrl=move_c,
        )
        self.__parser.EncodeMessage(msg, tx_can)
        # print(hex(tx_can.arbitration_id), tx_can.data)
        self.__arm_can.SendCanMessage(tx_can.arbitration_id, tx_can.data)
    ...
    def MotorMaxSpdSet(
        self, motor_num: Literal[1, 2, 3, 4, 5, 6] = 6, max_joint_spd: int = 3000
    ):
        """
    ...
    def JointConfig(
        ...
        joint_config = ArmMsgJointConfig(
            joint_num, set_zero, acc_param_is_effective, max_joint_acc, clear_err
        )
        msg = PiperMessage(
    ...
    def JointMaxAccConfig(
        self, motor_num: Literal[1, 2, 3, 4, 5, 6] = 6, max_joint_acc: int = 500
    ):
        """
        关节最大加速度设置指令
    ...
    def SetInstructionResponse(
        self, instruction_index: int, zero_config_success_flag: Literal[0, 1] = 0
    ):
        """
        设置指令应答
    ...
    def __JointMitCtrl(
        ...
        tx_can = Message()
        mit_ctrl = ArmMsgJointMitCtrl(
            pos_ref=pos_tmp, vel_ref=vel_tmp, kp=kp_tmp, kd=kd_tmp, t_ref=t_tmp
        )
        if motor_num == 1:
            msg = PiperMessage(
                type_=ArmMsgType.PiperMsgJointMitCtrl_1, arm_joint_mit_ctrl=mit_ctrl
            )
        elif motor_num == 2:
            msg = PiperMessage(
                type_=ArmMsgType.PiperMsgJointMitCtrl_2, arm_joint_mit_ctrl=mit_ctrl
            )
        elif motor_num == 3:
            msg = PiperMessage(
                type_=ArmMsgType.PiperMsgJointMitCtrl_3, arm_joint_mit_ctrl=mit_ctrl
            )
        elif motor_num == 4:
            msg = PiperMessage(
                type_=ArmMsgType.PiperMsgJointMitCtrl_4, arm_joint_mit_ctrl=mit_ctrl
            )
        elif motor_num == 5:
            msg = PiperMessage(
                type_=ArmMsgType.PiperMsgJointMitCtrl_5, arm_joint_mit_ctrl=mit_ctrl
            )
        elif motor_num == 6:
            msg = PiperMessage(
                type_=ArmMsgType.PiperMsgJointMitCtrl_6, arm_joint_mit_ctrl=mit_ctrl
            )
        else:
    ...
    def GripperTeachingPendantParamConfig(
        ...
        """
        tx_can = Message()
        gripper_teaching_pendant_param_config = ArmMsgGripperTeachingPendantParamConfig(
            teaching_range_per, max_range_config, teaching_friction
        )
        msg = PiperMessage(
            type_=ArmMsgType.PiperMsgGripperTeachingPendantParamConfig,
            arm_gripper_teaching_param_config=gripper_teaching_pendant_param_config,
        )
        self.__parser.EncodeMessage(msg, tx_can)
        self.__arm_can.SendCanMessage(tx_can.arbitration_id, tx_can.data)

    # ----------------------------------------------------------------------------------
    def GetSDKJointLimitParam(
    ...
    def SetSDKGripperRangeParam(self, min_val: float, max_val: float):
